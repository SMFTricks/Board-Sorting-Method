...
[b][size=5]Board Sorting Method[/size][/b]
...
[size=1em]Board Sorting Method will provide the options to select a different default sort order for each board.[/size]

[size=3][color=#1f4882]Features[/color][/size]
[list]
[li][size=0.9em]Select default sorting method[/size][/li]
[li][size=0.9em]Select default sorting order[/size][/li]
[/list]
...
[size=3][url="https://github.com/SMFTricks/Board-Sorting-Method/blob/main/CHANGELOG.md"][color=#cc5d31]Changelog[/color][/url][/size]
[size=3][url="https://github.com/SMFTricks/Board-Sorting-Method"][color=#5e2b82]GitHub[/color][/url][/size]